...
@interface WKSetVideoViewController ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
-(void)updateVideoset{
    ...
    NSDictionary *dic = @{@"loginUserId":LOGINUSERID,@"schoolId":SCOOLID,@"ids":cellid,@"videoType":[NSNumber numberWithInteger:self.classify.selectedSegmentIndex +1],@"gradeId": [NSNumber numberWithInteger:model.courseSection],@"courseId": [NSNumber numberWithInteger:model.id]};
